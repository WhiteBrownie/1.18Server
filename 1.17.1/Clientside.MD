...
1. In order to play Minecraft on 1.18 you need Java Version 16, you can download it from directly from [DeepWolfX](https://drive.google.com/file/d/1-fm_tPKuRIn0JHOpm4nZ10Ti0tiH06Aq/view)'s GoogleDrive or from the official website [here](https://www.oracle.com/java/technologies/javase/jdk16-archive-downloads.html) (what you want is the `Windows x64 Installer` of the `Java SE Development Kit 16.X.X`) (you will need an Oracle account for that tho)
2. Go ahead and download [MultiMC](https://multimc.org/#Download)
3. Extract MultiMC into a location of your choosing, it will stay there!
4. Download the newest version of the MultiMC instance from [here](https://1drv.ms/u/s!AnRpVm46qqDNjdUy9MNKb798AQLBOg?e=OeDgn7)

...
4. Hol dir die neuste MultiMC Instanz (eine .zip Datei **ohne** `_mods` am Ende!) von [hier](https://1drv.ms/f/s!AnRpVm46qqDNjdUyINmGchLVMbRdhw), benutz das Passwort vom Discord. Entpacke die Datei nicht, einfach so behalten erstmal

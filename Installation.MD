...
4. [Clientside Installation (deutsch)](Installation.MD#clientside-installation)
...
4. Download the newest version of the MultiMC instance (a .zip file!) from [here](https://1drv.ms/f/s!AnRpVm46qqDNjdUyINmGchLVMbRdhw), use the provided password from discord to gain access. Don't unzip the file, just keep it as is
...
4. Hol dir die neuste MultiMC Instanz (eine .zip Datei!) von [hier](https://1drv.ms/f/s!AnRpVm46qqDNjdUyINmGchLVMbRdhw), benutz das Passwort vom Discord. Entpacke die Datei nicht, einfach so behalten erstmal
